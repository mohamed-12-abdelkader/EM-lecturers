...
بعد ظهور المقترح يمكنك التعديل تدريجياً حتى تعتمد النسخة النهائية:
• شيل السؤال 3
• استبدل السؤال 1 و2
• شيل السؤال الأخير
• اعتماد الأسئلة`;
...
export const EXAM_BUILDER_QUICK_EXAMPLES = [
  ...
  { label: 'شيل سؤال من المقترح', message: 'شيل السؤال 3' },
  { label: 'استبدال سؤال', message: 'استبدل السؤال 1' },
];
