...
import { router as adminYoutubeRouter } from './controllers/adminYoutube';
...
import { router as teacherPointsRouter } from './controllers/teacherPoints';
import { router as studentPointsRouter } from './controllers/studentPoints';
...
router.use('/teacher/points', teacherPointsRouter);
...
router.use('/student/points', studentPointsRouter);
