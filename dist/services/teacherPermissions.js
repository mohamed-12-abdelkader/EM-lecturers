...
exports.TeacherPermissionService = void 0;
const pool_1 = __importDefault(require("../db/pool"));
class TeacherPermissionService {
    // Grant permission to teacher
    static async grant(questionBankId, subjectId, adminId, data) {
    ...
    `;
        const teacherResult = await pool_1.default.query(teacherQuery, [teacher_id]);
    ...
    `;
        const existingResult = await pool_1.default.query(existingQuery, [teacher_id, subjectId, questionBankId]);
    ...
    static async getBySubject(questionBankId, subjectId) {
        const query = `
      SELECT 
        tp.*,
    ...
    static async revoke(permissionId) {
      ...
      WHERE id = $1
    `;
        const result = await pool_1.default.query(query, [permissionId]);
...
exports.TeacherPermissionService = TeacherPermissionService;
