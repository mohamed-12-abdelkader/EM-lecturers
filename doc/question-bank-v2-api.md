...
نظام موحد لإدارة **أنواع الأسئلة** في بنك الأسئلة (نصية، صور، قطع قراءة).

> **هيكل المحتوى:** بنك → مادة → **كتاب** → فصل → درس — راجع [`questionBank.md`](./questionBank.md).  
> أسئلة V2 تُربط بـ `lesson_id`.
