...
| أجهزة الطالب | **جلسة واحدة فقط** — Login من جهاز جديد يلغي التوكين القديم على أي جهاز آخر |
| ربط IP (اختياري) | المدرس يفعّل `single_device` لربط الحساب بـ IP بالإضافة لتقييد الجلسة |
| المدرس / الأدمن | أكثر من جهاز في نفس الوقت — الدخول من جهاز جديد لا يلغي الباقي. كل توكن سنة من وقت إصداره بدون تمديد |
