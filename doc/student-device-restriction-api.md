...
- `multiple_devices` (افتراضي): لا ربط IP. جلسة الطالب تبقى واحدة (Login جديد يلغي التوكين القديم).
- `single_device`: بالإضافة لجلسة واحدة، يُربط الحساب بـ IP أول جهاز.
