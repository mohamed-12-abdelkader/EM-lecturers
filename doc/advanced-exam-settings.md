...
- **`lock_next_lectures`**: إذا كان `true`، لا يمكن للطلاب الوصول للمحاضرات التالية حتى ينجحوا في التقييم

### قاعدة القفل (محدثة)
- القفل يُطبَّق **فقط** عندما تكون المحاضرة فيها **تقييم واحد ظاهر** (امتحان أو واجب) و`lock_next_lectures = true`.
- لو المحاضرة فيها **أكتر من واجب أو امتحان ظاهر** → المحاضرات التالية **مفتوحة** ولا ينطبق عليها القفل.
- عند إنشاء واجب بدون تحديد `lock_next_lectures` يكون الافتراضي **`true`** (لكنه لن يقفل لو وُجد أكثر من تقييم ظاهر).
...
يمكن تكرار الطلب أكثر من مرة لنفس `lectureId` لإنشاء واجب ثانٍ وثالث... (ومع وجود أكثر من تقييم ظاهر لن تُقفل المحاضرات التالية).
